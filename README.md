...
This is an empty repo to initialize an R project for a class from
...
``` sh
git clone https://github.com/jaredlander/canada202102.git
```

Then open the `canada202102.Rproj` file.
...
Paste `https://github.com/jaredlander/canada202102`[3] in the
...
# get the repo
newProject <- usethis::use_course('https://github.com/jaredlander/canada202102/archive/master.zip')
```
...
`canada202102` or `canada202102-master`. You can see this in the top
...
[2] Or git clone <git@github.com>:jaredlander/canada202102.git for ssh.

[3] Or <git@github.com>:jaredlander/canada202102.git for ssh.
